...
自动推断 TSA-Suite 项目根目录，并提供真实工业预测流程中使用的各目录路径。
"""
...
def get_tsa_suite_dir() -> Path:
    ...
    # 兜底：保持旧行为，向上两级（.claude/skills/<skill-name>/ 到项目根目录）
...
def setup_paths():
    ...
    return {
        ...
        "PREPROCESSED_DIR": repo_root / "preprocessed_tsa",
        "MODEL_DIR": repo_root / "saved_models" / "tsa_itransformer",
